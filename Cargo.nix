  ...
  internal = rec {
    ...
    crates = {
      ...
      "env_filter" = rec {
        ...
        version = "1.0.2";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/env_filter; };
        dependencies = [
          {
            name = "log";
            packageId = "log";
      ...
      "snapbox" = rec {
        ...
        edition = "2021";
        crateBin = [];
        sha256 = "19v6fa50nsq8gd4jqgddx6km7wqkbp36wspp4sinpkyqi518pxvj";
        dependencies = [
          {
            name = "anstream";
            packageId = "anstream";
        ...
        resolvedDefaultFeatures = [ "color" "color-auto" "default" "diff" ];
      };
      "snapbox-macros" = rec {
        crateName = "snapbox-macros";
        version = "1.0.1";
        edition = "2021";
        sha256 = "11jk2l92k5cdcakxcqc5wwpgf7iiyrpk6xk602k0jhs07m24hann";
